...
import { P as PUBLIC_ROUTES, R as ROUTES } from './chunks/routes_Be0JyTu8.mjs';
import { A as AstroError, R as ResponseSentError } from './chunks/astro/assets-service_DxVWRvTk.mjs';
...
const onRequest$1 = defineMiddleware(async (context, next) => {
  ...
  if (isLoggedIn && (pathname === ROUTES.CREATE_ACCOUNT || pathname === ROUTES.LOGIN)) {
