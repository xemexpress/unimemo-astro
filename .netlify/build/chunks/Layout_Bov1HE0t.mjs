import { c as createComponent, r as renderTemplate, m as maybeRenderHead, e as renderSlot, d as createAstro, b as addAttribute, s as spreadAttributes, u as unescapeHTML, a as renderComponent, f as renderHead } from './astro/server_By5UoXfJ.mjs';
import 'kleur/colors';
import 'clsx';
import { O as OUR_BRAND } from './constants_zJHtZRx4.mjs';
import { R as ROUTES } from './routes_Be0JyTu8.mjs';
import '@astrojs/internal-helpers/path';
import { $ as $$Image, a as getImage } from './_astro_assets_BUhn7O56.mjs';
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><!-- Google tag (gtag.js) --><script type="text/partytown" async src="https://www.googletagmanager.com/gtag/js?id=G-0DX2BT6EQ9"><\/script><script type="text/partytown">\n            window.dataLayer = window.dataLayer || [];\n            function gtag() {\n                dataLayer.push(arguments);\n            }\n            gtag("js", new Date());\n\n            gtag("config", "G-0DX2BT6EQ9");\n        <\/script><meta charset="utf-8"><link rel="sitemap" href="/sitemap-index.xml"><link rel="icon" type="image/png"', '><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="generator"', ">", '<meta name="google-site-verification" content="LcgIWvFWzJ_TFe9E2nuM6LfmtdXoSfwl5HX0En1P9Is">', '</head> <body class="min-h-screen grid grid-rows-[auto,1fr,auto]"> ', " ", " ", " ", ' <!-- Improved Toast Notification Container --> <div id="toast" class="fixed bottom-4 left-4 right-4 sm:left-1/2 sm:-translate-x-1/2 px-4 py-2 sm:px-6 sm:py-3 rounded-lg text-white opacity-0 transition-all duration-300 ease-in-out z-50 shadow-lg sm:max-w-md text-center"></div>  </body> </html>'])), addAttribute(faviconSrcPNG, "href"), addAttribute(Astro2.generator, "content"), renderComponent($$result, "SEO", $$SEO, { "title": brandedTitle, "description": description, "openGraph": {
    basic: {
      title: brandedTitle,
      type,
      image: finalImageSrc,
