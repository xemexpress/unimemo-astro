...
import 'kleur/colors';
import { S as StringUtils, g as getCollection, P as ProductUtils } from './coreUtils_Bk_ZWNZ4.mjs';
...
${activeFilters.length > 0 && renderTemplate`<span class="text-sm font-normal text-gray-500" data-astro-cid-jdeevs2t> ${activeFilters.length} active
  ...
  })} </div>`} </details>`)} ${activeFilters.length > 0 && renderTemplate`<a href="/overview" class="text-sky-600 hover:text-sky-800 transition-colors text-sm" data-astro-cid-jdeevs2t>
Clear all filters
</a>`} </div>  `;
